const state = {
    quests: [{
        ...
        },
        {
            ...
            complete: true,
            id: 2,
            link: "http://www.iii-media.net/SAKURA",
